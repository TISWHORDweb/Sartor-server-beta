...
router.get('/stocks/user', useAsync(authMiddleware), useAsync(roleMiddleware(['user'])), GetUserStocks );
router.get('/stocks/company', useAsync(authMiddleware), useAsync(roleMiddleware(['user'])), GetCompanyStocks );
router.get('/merchandiser/overview', useAsync(authMiddleware), useAsync(roleMiddleware(['user'])), GetMerchandiserOverview );
