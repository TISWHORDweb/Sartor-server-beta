...
const { UserRegister, UserLogin, sartorRegister, partnerPasswordReset } = require('../controller/controller.auth');
...
//ALL
router.post('/password-reset', bodyParser, partnerPasswordReset);
